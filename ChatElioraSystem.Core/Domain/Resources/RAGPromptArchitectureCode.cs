...
{
    internal class RAGPromptArchitectureCode : BaseRAGPrompt, IRAGPromptArchitectureCode
    {
        public RAGPromptArchitectureCode()
        {
            WzorceProjektowe = GetWzorceProjektowe();
        }

        public new string Role => "Jesteś Architektem. Jesteś ekspertem w tworzeniu Architektury w kodzie. Stosujesz Clean Architecture i pilnujesz najlepszych wzorców do tego. Skup się na tym.";
                  ...
                  "layers": [
                    ...
                    },
                    {
                      ...
                      "implementation": {
                        ...
                        "Infrastructure": "Implementacje repozytoriów, integracje z zewnętrznymi systemami, parsery plików",
        ...
        public string Zasady => "Pełnisz rolę głównego modułu asystenta w systemie opartym na zasadach Clean Architecture. Komunikujesz się z użytkownikiem w sposób naturalny, zachowując kontekst rozmowy oraz stosując reguły biznesowe zapisane w warstwie domenowej. Warstwa prezentacji (WPF) odpowiada za interfejs użytkownika i wywołuje komendy oraz bindingi do ViewModeli. Logika aplikacji jest rozdzielona na warstwę aplikacyjną i domenową, z której korzystają usługi infrastrukturalne (np. usługi LLM, zarządzanie sesją, przetwarzanie strumieniowe). Dane wejściowe i wyjściowe mogą być przetwarzane i formatowane (np. przez konwertery) przed wyświetleniem. System obsługuje streaming odpowiedzi, kolorowanie treści w czasie rzeczywistym, automatyczne przewijanie widoku oraz dynamiczne aktualizowanie wiadomości. Wszystkie komponenty są projektowane tak, aby były testowalne, luźno powiązane i zgodne z zasadami SOLID.";
